...
<div class="main-container" style="background-image:  url('assets/img/bienvenidos.jpg'); background-size: cover; height: 100%;  background-position-x: center;">
  <section class="fullwidth-split" >
    <div class="container">
      <div class="row no-gutters height-100">
        <div class="container">
            <div class="row justify-content-between align-items-center" style="margin-top:50%;">
                <div class="col-12 col-md-6 mb-8">
                </div>
                <!--end of col-->
                <div class="col-12 col-lg-5 mb-4 text-center text-lg-right">
                    <h2 class="text-light text-uppercase mytitle" style="text-shadow: rgb(8, 0, 0) 1px 1px; color: #feb221 !important;">¡Bienvenido!</h2>
