            ...
            <div class="col-12 col-md-6 card-body" style="padding: 1rem !important">
              ...
              <div class="row justify-content-center mt-3 mb-2">
                <div class="col-12 col-lg-9">
                  <div class="mb-1">
                    <span class="text-uppercase" style="font-weight: bold !important; color: #fe7011">Informacion personal</span>
                  </div>
                  <!--form-->
                  <div>
            ...
            <div class="col-12 col-md-6 card-body" style="background-color: #01548a">
              <div style="height: 100%">
                ...
                <div class="card card-sm shadow text-justify" style="height: 80%;">
                  ...
                  <li>En la foto de la factura enviada se deber&aacute; evidenciar claramente: el NIT y nombre del punto de venta, fecha de la compra, descripci&oacute;n del producto, precio de los productos y valor total de la compra.</li>
                  ...
                  <li>Los participantes en su cuenta podr&aacute;n verificar sus puntos acumulados, y el puesto en el que se encuentran en el ranking de participantes.</li>
                  ...
                  <p><strong>IMPORTANTE:</strong> Los participantes deber&aacute;n conservar las facturas registradas, dado que su presentaci&oacute;n es requisito para reclamar los premios. Los participantes deber&aacute;n enviar dentro de los 8 calendario siguientes en el que se les inform&oacute; que son ganadores foto de todas las facturas de compra que hayan registrado para acumular puntos &nbsp;al correo electr&oacute;nico <a href="mailto:ganaconramo@gmail.com">ganaconramo@gmail.com</a>, las cuales deben enviarse completas y ser n&iacute;tidas, ya que las mismas son verificadas para garantizar su validez, aquellas facturas cuyos datos no resulten v&aacute;lidos, no ser&aacute;n aceptadas y los puntos acumulados con las mismas ser&aacute;n descontados de la cuenta del participante.</p>
                  ...
                  <li>Registrate en la plataforma web <a href="http://www.ganaconramo.com">ganaconramo.com</a>, encontrar&aacute;s un link en la p&aacute;gina de TiendaRamo.com que dirigir&aacute; a la plataforma de la actividad. Con la apertura de la cuenta, y/o recibo del premio todos los participantes declaran aceptar y conocer los t&eacute;rminos y condiciones.</li>
                  <li>En la p&aacute;gina web <a href="http://www.ganaconramo.com">ganaconramo.com</a>, el participante deber&aacute; asignar un usuario y contrase&ntilde;a, la cual es personal e intransferible. El usuario queda relacionado con el n&uacute;mero de c&eacute;dula proporcionado y no podr&aacute; ser modificado.</li>
                  <li>Los participantes en su cuenta podr&aacute;n verificar sus puntos acumulados, y el puesto en el que se encuentran en el ranking de participantes.</li>
                  ...
                  <p>Conocer, actualizar y rectificar&nbsp;sus&nbsp;datos personales&nbsp;cuando identifiquen&nbsp;que hay datos parciales, inexactos, incompletos, fraccionados, que induzcan a error, entre otros.&nbsp;</p>
                  <ol>
